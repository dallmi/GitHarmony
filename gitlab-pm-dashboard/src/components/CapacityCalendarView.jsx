...
/**
 * Enterprise Capacity Calendar View
 * Interactive Gantt-style absence planning with automatic sprint capacity integration
 */
export default function CapacityCalendarView({ issues }) {
  ...
  // Load data - reload when project changes
  useEffect(() => {
  ...
  if (teamMembers.length === 0) {
    return (
      <div className="container" style={{ padding: '40px', textAlign: 'center' }}>
        <h2>⚙️ Capacity Calendar</h2>
        <p>Please configure your team members first.</p>
      </div>
    )
  }
    ...
    <div className="container" style={{ padding: '20px' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        <p style={{ color: '#6B7280', marginBottom: '20px' }}>
          Plan team absences and automatically adjust sprint capacity
        </p>
          ...
          <div style={{
            ...
            <div>
              <div style={{ fontWeight: '600', color: '#92400E', marginBottom: '4px' }}>
                Cross-Project View (Read-Only)
              </div>
              <div style={{ fontSize: '13px', color: '#92400E' }}>
                You're viewing absences from all projects. To add or edit absences, please select a specific project from the filter dropdown.
                Different projects have different teams and sprint schedules.
              </div>
            </div>
          </div>
        )}
